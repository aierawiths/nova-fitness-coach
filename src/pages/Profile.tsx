...
import {
  User, Settings, Crown, ChevronRight, LogOut,
  Dumbbell, Apple, ScanLine, TrendingUp
} from "lucide-react";
      ...
      <div className="px-6 pt-6 pb-4">
        ...
        >
          ...
          <div className="flex-1">
            <h2 className="font-display text-lg font-bold text-foreground">Alex Johnson</h2>
        ...
        >
          <button
            ...
            className="w-full mt-4 p-4 rounded-2xl bg-gradient-primary flex items-center gap-3 group"
          >
        ...
        >
          ...
          <StatItem icon={Dumbbell} label="Workouts completed" value="48" />
          <StatItem icon={Apple} label="Meals tracked" value="156" />
          <StatItem icon={ScanLine} label="Foods scanned" value="89" />
          <StatItem icon={TrendingUp} label="Day streak" value="7" />
        </motion.div>
